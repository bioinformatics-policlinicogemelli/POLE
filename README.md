...
Group of functions for cBioportal data update and deletion

Here we describe function for 
[update](https://github.com/bioinformatics-policlinicogemelli/varan-2.0/blob/Sviluppo/Update_functions.py) and for [delete](https://github.com/bioinformatics-policlinicogemelli/varan-2.0/blob/Sviluppo/Delete_functions.py) data. 

## Update functions

|FUNZIONE                |INPUT                          |DESCRIPTION                         |
|----------------|-------------------------------|-----------------------------|
|update_clinical_samples | old data_clinical_sample.txt and file with new data to add | Combine **by rows** old and new files to generate an updated file 
|update_cna_hg19 | old data_cna_hg19.seg and file with new data to add | Combine **by rows** old and new files to generate an updated file 
|update_cna | old data_cna.txt and file with new data to add | Combine **by columns** old and new files to generate an updated file 
|update_mutations| old data_mutations_extended.txt and file with new data to add | Combine **by rows** old and new files to generate an updated file 
|update_sv| old data_sv.txt and file with new data to add | Combine **by rows** old and new files to generate an updated file 
|update_caselist_cna| old caselist_cna.txt and file with new data to add | Add new sample IDs to case_list_ids field of old file and update n° of samples in case_list_description
|update_caselist_sequenced| old caselist_sequenced.txt and file with new data to add | Add new sample IDs to case_list_ids field of old file and update n° of samples in case_list_description
|update_caselist_sv| old caselist_sv.txt and file with new data to add | Add new sample IDs to case_list_ids field of old file and update n° of samples in case_list_description

## Delete functions
|FUNZIONE                |INPUT                          |DESCRIPTION                         |
|----------------|-------------------------------|-----------------------------|
|delete_clinical_samples | data_clinical_sample.txt and list of samples to remove | Remove sample data from given file
|delete_cna_hg19 | data_cna_hg19.seg and list of samples to remove | Remove sample data from given file
|delete_cna | data_cna.txt and list of samples to remove|Remove sample data from given file
|delete_mutations| data_mutations_extended.txt and list of samples to remove | Remove sample data from given file
|delete_sv| data_sv.txt and list of samples to remove | Remove sample data from given file
|delete_caselist_cna| caselist_cna.txt and list of samples to remove|Remove sample data from given file and update n° of samples in case_list_description
|delete_caselist_sequenced| old caselist_sequenced.txt and list of samples to remove|Remove sample data from given file and update n° of samples in case_list_description
|delete_caselist_sv| caselist_sv.txt and list of samples to remove |Remove sample data from given file and update n° of samples in case_list_description
